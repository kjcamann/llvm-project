...
template<typename T> struct A {
  // FIXME: This diagnostic is horrible.
  enum E : T::type {}; // expected-error{{ISO C++ forbids forward references}} expected-error{{field has incomplete type}} expected-note{{forward declaration}}
