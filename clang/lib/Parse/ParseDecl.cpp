...
Parser::DeclGroupPtrTy Parser::ParseDeclGroup(ParsingDeclSpec &DS,
  ...
  if (D.isFunctionDeclarator() &&
    ...
    if (Context == DeclaratorContext::FileContext) {
      ...
      if (isDeclarationSpecifier(ImplicitTypenameContext::Never)) {
...
void Parser::ParseDeclarationSpecifiers(
  ...
  if (DSContext == DeclSpecContext::DSC_conv_operator) {
    ...
    AllowImplicitTypename = ImplicitTypenameContext::Never;
  ...
  if (AllowDeclaration && Tok.is(tok::colon)) {
    ...
    if (CanBeBitfield) {
      ...
      // fixed underlying type.
        ...
        // this case.
        if ((getLangOpts().CPlusPlus &&
             isCXXDeclarationSpecifier(ImplicitTypenameContext::Never,
                                       TPResult::True) != TPResult::True) ||
            (!getLangOpts().CPlusPlus &&
             !isDeclarationSpecifier(ImplicitTypenameContext::Never, true))) {
...
bool Parser::isDeclarationSpecifier(
  ...
  case tok::coloncolon:   // ::foo::bar
    ...
    if (TryAnnotateTypeOrScopeToken())
      return true;
    return isDeclarationSpecifier(ImplicitTypenameContext::Never);
...
bool Parser::isConstructorDeclarator(bool IsUnqualified, bool DeductionGuide,
  ...
  if (isDeclarationSpecifier(IsFriend ? ImplicitTypenameContext::Never
  ...
  while (1) {
    if (Tok.is(tok::l_paren)) {
      ...
      if (getLangOpts().CPlusPlus && D.mayBeFollowedByCXXDirectInit()) {
        ...
        auto AllowImplicitTypename = ImplicitTypenameContext::Never;
        if (D.getCXXScopeSpec().isSet())
          AllowImplicitTypename =
  ...
  if (!D.mayOmitIdentifier()) {
    ...
    isGrouping = true;
             ...
             isDeclarationSpecifier(
                 ImplicitTypenameContext::Never) || // 'int(int)' is a function.
...
void Parser::ParseParameterDeclarationClause(
  ...
  if (DeclaratorCtx == DeclaratorContext::MemberContext ||
      ...
      IsQualifiedFunctionDeclaration)
    AllowImplicitTypename = ImplicitTypenameContext::Yes;
