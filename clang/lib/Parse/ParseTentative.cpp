...
bool Parser::isCXXSimpleDeclaration(bool AllowForRangeDecl) {
  ...
  TPResult TPR = isCXXDeclarationSpecifier(
      ImplicitTypenameContext::Never, TPResult::False, &InvalidAsDeclaration);
...
Parser::TPResult Parser::TryParseSimpleDeclaration(bool AllowForRangeDecl) {
  ...
  if (Tok.isNot(tok::l_paren)) {
    TPResult TPR = isCXXDeclarationSpecifier(ImplicitTypenameContext::Never);
    if (TPR == TPResult::Ambiguous)
...
Parser::isCXXConditionDeclarationOrInitStatement(bool CanBeInitStatement,
  ...
  if (State.update(isCXXDeclarationSpecifier(ImplicitTypenameContext::Never)))
    return State.result();
...
Parser::TPResult Parser::isTemplateArgumentList(unsigned TokensToSkip) {
  ...
  if (isCXXDeclarationSpecifier(ImplicitTypenameContext::Never, TPResult::False,
